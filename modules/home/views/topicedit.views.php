...
<div class="col-md-9 col-md-push-3" role="main">
    <div class="page-header">
        <ul class="nav nav-pills" role="tablist">
            <li role="presentation" class="active"><a href="/home/home/topic">头条列表</a></li>
            <li role="presentation"><a>头条编辑</a></li>
        </ul>
    </div>

    <div>
        <form action="/home/home/topicedit?id=<?php echo $id;?>" method="post" class="form-horizontal" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    layer.msg('修改成功',{icon:1,time:1500},function(){
        window.location.href="/home/home/topic";
    });
    <?php }?>
    <?php if ($error!=''){?>

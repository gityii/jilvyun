...
<div class="col-md-9"  role="main">
    ...
    <div class="page-header" style="margin-top: 0px">
        <h3 style="margin-top: 0px">通知设置</h3>
    </div>
    <p>
        <a class="btn btn-lg btn-success" href="/home/home/noticeadd" role="button">
            <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> 添加通知
        </a>
    </p>
                ...
                <?php foreach ($list as $v){?>
                    <tr id="tr_<?php echo $v['id'];?>">
                        ...
                        <td class="text-center">
                            <a class="btn btn-primary" href="/home/home/noticeedit?id=<?php echo $v['id'];?>">编辑</a>

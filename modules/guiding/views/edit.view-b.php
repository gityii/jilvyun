...
<div class="bread">
	<a href="/guiding/guiding/rule">服务列表</a>
	<span>/</span><?php echo $id>0?'编辑':'添加';?>服务
</div>
<div class="main-bd">
        <form action="" mathod="get" class="form-horizontal">
            <div class="form-group form-group-lg">
                <label class="col-sm-2 control-label" style="text-align:left; width: 9%" for="">项目 :</label>
                <div class=" col-xs-3">
                    <input type="text" class="form-control" id="exampleInputName2" placeholder="项目">
                </div>
            </div>
